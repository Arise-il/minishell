...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/14 15:14:26 by oouhlale          #+#    #+#             */
/*   Updated: 2024/11/18 11:39:10 by oouhlale         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	**split_words(char const *s, char c, char **s2, int num_words)
{
	...
	while (word < num_words)
	{
		...
		s2[word] = (char *)ft_malloc(sizeof(char) * (word_len + 1), 1);
		if (!s2[word])
			return (NULL);
...
char	**ft_split(char const *s, char c)
{
	...
	s2 = (char **)ft_malloc(sizeof(char *) * (num_words + 1), 1);
	if (!s2)
		return (NULL);
	if (num_words == 0)
	{
